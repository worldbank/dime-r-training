...
Have ever seen these lines of code before?
...
* What about working directories? We usually use `cd "path/in/my/computer"` every time we start a new script in Stata
