...
* In Stata, we use `foreach` loops quite a lot
...
* The difference is like this:
  ...
  + Otherwise, you can ask them to raise their hands and collect the answers at once -- __this is `apply()`__
...
Create a function that calculates the z-score of a vector.
