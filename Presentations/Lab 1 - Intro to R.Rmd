 ...
 * __Exporting summary statistics and regression tables__ (Nov 20)
 * __Creating awesome-looking plots__ (Nov 29)
 * __Writing reproducible and readable code__ (Dec 6)
 * __Creating awesome-looking maps__ (Dec 13)
 * __Cleaning data__ (Dec 20)


For the most recent versions of these trainings, visit the R-training Git Hub repo at
...
### Exercise 1: Import data
 ...
 1. In RStudio, go to File > Import Dataset > From Text (Base) and open the whr_panel.csv file. Depending on your Rstudio version, it might be File > Import Dataset > From CSV
...
\begin{figure}
\centering
  \includegraphics[scale=0.45]{img/new/import_data1.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[scale=0.5]{img/new/import_data2.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/interface.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/enviroment.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/scritpt1.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/scritpt2.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/scritpt3.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[width=12cm,height=7.7cm]{img/new/scritpt4.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[scale=0.4]{img/new/View.png}
\end{figure}
...
\begin{figure}
\centering
  \includegraphics[scale=0.5]{img/new/enviroment_2vars.png}
\end{figure}
...
Since objects are the building blocks of R programming, this section will explore some of the most common.
...
\begin{figure}
\centering
  \includegraphics[scale=0.46]{img/new/enviroment_factors.png}
\end{figure}
