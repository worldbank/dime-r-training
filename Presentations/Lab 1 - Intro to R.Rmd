...
\textcolor{red}{To better understand the idea, we're going to use the data from the Rwanda LWH project. First, let's take a look at the data.}
...
\textcolor{red}{Building blocks of R, bla bla bla}
