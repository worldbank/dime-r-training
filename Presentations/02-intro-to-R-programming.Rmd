...
### Exercise 2 `r fa("keyboard")` <font size="5">(`r fa("clock")` 1 min)</font>
...
### Exercise 5 `r fa("keyboard")` <font size="5">(`r fa("clock")` 1 min)</font>
...
### Exercise 6: Looping over a dataframe <font size="5">(`r fa("clock")` 3 min)</font>
...
### Exercise 7: Now use `map()` `r fa("keyboard")` <font size="5">(`r fa("clock")` 1 min)</font>
...
### Exercise 8 `r fa("keyboard")` <font size="5">(`r fa("clock")` 2 min)</font>
