...
* Remember we said yesterday that you could use single or double brackets to index list items?

  + `[]`: returns a list of one item containing the element selected
  + `[[]]`: returns the element selected itself

* This difference is crucial when working with `map()`, because it always returns a list
