...
1. Go to the [OSF page of the course](https://osf.io/86g3b/) and download the file in: `R for Stata Users - 2023 March` > `Data` > `DataWork.zip`
...
1. Go to `File` > `New File` > `R Script` and save this empty script in `DataWork` > `Code` as `exercises-session2.R`
