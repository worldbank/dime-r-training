...
# What if I want to export tables to different tabs in Excel?
...
The code below exports the same table to a self-standing LaTeX document
...
# What if I want to export only a table fragment to LaTeX?
...
You will also need to load the required LaTeX packages
