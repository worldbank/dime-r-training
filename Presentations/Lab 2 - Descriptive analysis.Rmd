...
```{r, include = T, results = "hide", eval = F}
  install.packages(c("stargazer", 
                     "tidyverse"), 
                   dependencies = T) # dependencies argument 
#installs all other packages that it may depend upon to run
...
## Using packages
  ...
  \begin{block}{Exercise 1}
    Now load the packages we just installed. Note that the \texttt{library} function only accepts one argument, so you will need to load each of them separately.
  \end{block}
