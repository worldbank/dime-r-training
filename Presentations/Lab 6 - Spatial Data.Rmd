...
# Create a bounding box that encompasses all of our coordinates
...
<!-- par(mfrow=c(2,2)) -->
<!-- plot(get_map(location = centroid, maptype = "roadmap"), main = "roadmap") -->
<!-- plot(get_map(location = centroid, maptype = "satellite"), main = "satellite") -->
<!-- plot(get_map(location = centroid, maptype = "watercolor"), main = "watercolor") -->
<!-- plot(get_map(location = centroid, maptype = "toner"), main = "toner") -->
<!-- ``` -->
