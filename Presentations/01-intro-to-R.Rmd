...
- You can join our Slack workspace using [this link](https://join.slack.com/t/worldbank-network/shared_invite/zt-xxcai60m-7_E_oBFFQe1tzrSCTNmEmQ)
...
For the most recent versions of these trainings, visit the DIME-R-training GitHub repository at
...
1. Go to the OSF page of the course (https://osf.io/86g3b/) and download the file located in `R for Stata Users - November 2021` > `Data` > `whr_panel.csv`
...
We'll learn a more about factors in a later session, since they are important for the kind of analysis we usually do. For now, here are two important things to keep in mind when using them.
