...
We'll learn more about factors on a later session, since they are important for the kind of analysis we usually do. For now, here are two important things to keep in mind when using them.
