...
annualHappy_reg <- aggregate(happiness_score ~ year + region, data = whr, FUN = mean)
plot <- ggplot(annualHappy_reg,aes(y = happiness_score,x = year, color = region, group = region)) +
