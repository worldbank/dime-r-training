...
1. Make sure the `Environment` window is open. Is anything there?

2. Create an object called `foo` with any content you pick

3. Type `rm(foo)` to remove the `foo` object from you memory

4. Type `ls()` to print the names of all the object in memory
