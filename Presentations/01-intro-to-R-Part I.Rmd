...
<img width=45% src="img/import_data1.png" />

---

# Getting started

<img width=50% src="img/import_data2.png" />
...
<img height=70% width=70% src="img/Interface.png" />

---

# RStudio interface

<img height=70% width=70% src="img/environment.png" />

---

# RStudio interface

<img height=70% width=70% src="img/scritpt1.png" />

---

# RStudio interface

<img height=70% width=70% src="img/scritpt2.png" />

---

# RStudio interface

<img height=70% width=70% src="img/scritpt3.png" />

---

# RStudio interface

<img height=70% width=70% src="img/scritpt4.png" />
...
<img height=75% width=75% src="img/View.png" />
...
<img height=50% width=50% src="img/environment_2vars.png" />
...
### Two important concepts to take note:
 ...
 3. Print (display) is built into R. If you execute any action without storing it, R will simply __print the results of that action__ but won't save anything in the memory.
...
* An object is like a global in Stata, it's __something you can refer to later__ in your code to get a value.
...
The `whr` and `whr2015` objects are both data frames. You can also construct a new data frame from scratch by __combining vectors with the same number of element__.
...
<img height=55% width=55% src="img/environment_factors.png" />
