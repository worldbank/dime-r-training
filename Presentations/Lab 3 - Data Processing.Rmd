...
* The main issue, at least fornow, of saving a data set as CSV is that when you open it again all strings and factors will be imported in the same format (either strings or factors, depending on how you set the ``stringsAsFactors`` option). 
