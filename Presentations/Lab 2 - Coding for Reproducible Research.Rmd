...
## Objectives
  ...
  \begin{itemize}
    ...
    \item A master script It's not specific to R, it's just good programing practice Here we'll use it as an example to show you important features of R programing.
  \end{itemize}
...
## Looping
  ...
  \begin{block}{Exercise 13}
    ...
    TIP: Set the  \texttt{character.only} argument equal to \texttt{TRUE}
  \end{block}
