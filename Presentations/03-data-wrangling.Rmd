...
1. Create a folder named `dime-r-training-mar2024` in your preferred location in your computer.

2. Go to the [OSF page of the course](https://osf.io/86g3b/) and download the file in: `R for Stata Users - 2024 March` > `Data` > `dime-r-training-mar2024.zip`.

3. Unzip `dime-r-training-mar2024.zip`.

4. Open the `dime-r-training-mar2024` R project.
]
...
- To organize data in a way that it will be easier to analyze and communicate it.
