...
Plot projects in Narobi on top of a basemap. As a challenge, make the size of the points correspond to the size of aid commitments.

Hint: Use size in the aesthetics.
\end{block}

```{r, eval=F}
# Code where size does not correspond to aid commitments
ggmap(nairobi_map) + 
    geom_point(data=wb_projects, aes(x=longitude,
                                    y=latitude),
               color="orange") +
...
Here's the code to make point size correspond with commitments.
