...
The code also shows alternative ways of loading the shapefile, in case the first way doesn't work.  
...
# POTENTIAL ISSUE 1: Can't find file.
#   In this case, try setting the working directory
#   to the folder where the shapefile is
#     setwd(finalData)
#     worldmap <- readOGR(dsn=".", layer="worldmap")

# POTENTIAL ISSUE 2: Can't find gdal
...
#    ~longitude+latitude is a formular, where ~ tells R to  
#    reference those variables in the associated datasets;
#    in this case, kenya_projects
