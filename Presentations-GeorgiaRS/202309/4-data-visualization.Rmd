...
ADD IMAGE OF DATA WORK PIPELINE WITH DATA VIS AS OUTPUTS
...
Use `ggsave("vat_liability_small_2019_by_group.png")` to save your plot
...
Use `ggsave("vat_liability_small_2019_text.png")` to save this last plot
...
IMAGE WITH CHECKS IN EACH STAGE OF PIPELINE
...
IMAGE WITH SQL DATABASE AS INPUT
