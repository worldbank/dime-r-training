...
## Exercício 3: Carregando dados no R
 ...
 1.- Vá para esta página: https://osf.io/2apht e baixe o arquivo `small_business_2019_br.csv` <span style="color:red"> WE NEED TO UPDATE THIS PATH.</span>
...
```{r echo = FALSE, out.width="95%"}
knitr::include_graphics("img/session1/function-br.png")
```
